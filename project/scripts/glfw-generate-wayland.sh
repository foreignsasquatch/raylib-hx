...
rm -f "$GLGLFW_PATH"/wayland-fractional-scale-v1-client-protocol.h
rm -f "$GLGLFW_PATH"/wayland-fractional-scale-v1-client-protocol-code.h
rm -f "$GLGLFW_PATH"/wayland-xdg-activation-v1-client-protocol.h
rm -f "$GLGLFW_PATH"/wayland-xdg-activation-v1-client-protocol-code.h
...
wayland-scanner private-code ./staging/fractional-scale/fractional-scale-v1.xml "$GLGLFW_PATH"/wayland-fractional-scale-v1-client-protocol-code.h
wayland-scanner client-header ./staging/fractional-scale/fractional-scale-v1.xml "$GLGLFW_PATH"/wayland-fractional-scale-v1-client-protocol.h

echo "Generating xdg-activation protocol..."
wayland-scanner private-code ./staging/xdg-activation/xdg-activation-v1.xml "$GLGLFW_PATH"/wayland-xdg-activation-v1-client-protocol-code.h
wayland-scanner client-header ./staging/xdg-activation/xdg-activation-v1.xml "$GLGLFW_PATH"/wayland-xdg-activation-v1-client-protocol.h
